...
```{r}
#folder_name = "../replication_egg_2/csv_egg/"

folder_name = "/Users/lana/Desktop/prgm/CSL/DNA-CA/results/alife_2023/fish/csv/1500/"
# folder_name = "/Users/lana/Desktop/prgm/CSL/DNA-CA/results/replication_fl/csv/"
...
levelplot(t(e_differences), main="DNA MSE", xlab="", ylab="", col.regions=pal(100))#, at=seq(0, max(e_differences), length.out=16))
# levelplot(e_differences, scales=list(x=list(rot=-90)),main="DNA MSE", xlab="", ylab="", col.regions=pal(100))


pal <- colorRampPalette(c("red", "yellow"), space = "rgb")
levelplot(t(f_differences), main="Phenotype MSE", xlab="", ylab="", col.regions=pal(100))#, at=seq(0, max(e_differences), length.out=16))
...
```{r}
# how about just plot diff from ancestor
a = e_differences[1,]
...
#plot(x=a, y = b, xlab = "DNA MSE", ylab = "Phenotype MSE" )
